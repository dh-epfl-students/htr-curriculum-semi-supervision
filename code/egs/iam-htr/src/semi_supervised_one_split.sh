...
cp data_icfhr/lang/puigcerver/lines/char/tr_sampled.txt data_icfhr/lang/puigcerver/lines/char/or_sampled.txt
or_f="data_icfhr/lang/puigcerver/lines/char/or_sampled.txt" 
va_f="data_icfhr/lang/puigcerver/lines/char/va_sampled.txt"
tr_unlabelled_txt_table="data_icfhr/lang/puigcerver/lines/char/tr_unlabelled_semi_supervised_sampled.txt"
...
--use_cl "false" \
--use_baseline "false" \
--use_different_alphabet "false" \
--use_reverse_cl "false" \
--use_semi_supervised "True" \
--non_decreasing_epochs_semi_supervised 100 \
--threshold_score_semi_supervised 0.0 \
--tr_unlabelled_txt_table $tr_unlabelled_txt_table \
--epoch_frequency_semi_supervision 8 \
--model_iam_path "$model_iam_path" \
--model_filename "model_icfhr" \
--weights "model_100.ckpt-last" \
--train_batch_size 128 \
--val_batch_size 128 \
--train_path "$model_iam_path" \
