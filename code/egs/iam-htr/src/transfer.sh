...
train_path=exper/puigcerver17/train/transfer;
mkdir -p "$train_path";
...
do
	tr_f="data_icfhr/lang/puigcerver/lines/char/cross_validation/cv$i/tr.txt"
	va_f="data_icfhr/lang/puigcerver/lines/char/cross_validation/cv$i/va.txt"
    # Train
