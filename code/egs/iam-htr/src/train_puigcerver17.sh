...
gpu=1;
img_directories="data_iam/imgs/lines_h128";
...
check_all_files \
  data_iam/lang/puigcerver/lines/char/tr.txt \
  data_iam/lang/puigcerver/lines/char/va.txt;

mkdir -p "$exper_path";
[ -s "$exper_path"/syms_ctc.txt ] ||
cut -d\  -f2- data_iam/lang/puigcerver/lines/char/{tr,va}.txt | tr \  \\n |
